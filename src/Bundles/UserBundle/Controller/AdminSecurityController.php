...
class AdminSecurityController extends ContainerAware
{
    ...
    public function loginAction()
    {
        ...
        return $this->container->get('templating')->renderResponse('BundlesUserBundle:Admin:Security/login.html.'.$this->container->getParameter('fos_user.template.engine'), array(
